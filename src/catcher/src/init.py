...
if __name__ == '__main__':
    ...
    while loop:
        try: 
            trans, rot = tf_buffer.lookup_transform("ar_marker2_5", 'base', rospy.Time())
            loop = False
    ...
    static_transformStamped.transform.translation = trans
    static_transformStamped.transform.rotation = rot
